...
function FarmerDashboard() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/dashboard/farmer-stats", {
    ...
    axios
      .get("http://localhost:5000/api/dashboard/my-crops", {
        headers: { Authorization: `Bearer ${token}` }
      })
    ...
    axios
      .get("http://localhost:5000/api/dashboard/farmer-revenue", {
        headers: { Authorization: `Bearer ${token}` }
      })
    ...
    axios
      .get("http://localhost:5000/api/dashboard/farmer-top-crops", {
        headers: { Authorization: `Bearer ${token}` }
      })
  ...
  const fetchOrders = () => {
    axios
      .get("http://localhost:5000/api/orders/farmer-orders", {
        headers: {
  ...
  // Accept or reject buyer offer
  const handleOfferResponse = async (
    orderId,
    decision
  ) => {
    setRespondingOfferId(orderId);

    try {
      await axios.put(
        `http://localhost:5000/api/orders/${orderId}/offer-response`,
        {
          decision
        },
        {
